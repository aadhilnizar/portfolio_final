...
const Contact = () => {
  ...
  const verifyEmail = async (email, retries = 3, delay = 5000) => {
      ...
      <>
        <div className="container contact-page">
          ...
          <div className="map-wrap">
            ...
            <MapContainer center={[8.893212, 76.614143]} zoom={13}>
              <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
              <Marker position={[8.893212, 76.614143]}>
                <Popup>
                  Aadhil lives here, come over for a cup of coffee :{')'}
                </Popup>
              </Marker>
            </MapContainer>
          </div>
